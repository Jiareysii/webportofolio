      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            from-yellow-500 via-orange-400 to-pink-500 mb-4'>Let's Talk</h3>
            <p>I'm open to discuss about web and mobile application design and opportunities.</p>
            <div className='mb-4 mt-8'>
                <FaEnvelope className='inline-block text-yellow-500 mr-2'></FaEnvelope>
                <a href="mailto:jiareysii@gmail.com" className='hover:underline'>
                    jiareysii@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-yellow-500 mr-2'></FaPhone>
                <span>+628 8888 8888</span>
            </div>
            <div className='mb-4'>
          ...
          <div className='flex-1 w-full'>
            <form className='space-y-4'>
                ...
                <button className='bg-gradient-to-r from-yellow-500 via-orange-400 to-pink-500 text-white hidden md:inline
